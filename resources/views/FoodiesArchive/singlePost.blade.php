        ...
        <div class="max-w-7xl mx-auto p-6">
            ...
            <div class="mt-2">
                ...
                <div class="w-full h-96 bg-gray-300 mt-2 rounded-md">
                    @if(!empty($food->restaurant->map_embed_url))
                        <iframe
                            src="{{ $food->restaurant->map_embed_url }}"
                            width="600" height="450"
                            loading="lazy"
                            style="border:0;"
                            allowfullscreen
                            aria-label="Map location for {{ $food->restaurant->name }}"
                            title="Map location of {{ $food->restaurant->name }}"
                            referrerpolicy="no-referrer-when-downgrade"
                            class="w-full h-full object-cover rounded-md transition-all duration-300 ease-in-out hover:scale-[1.01]"></iframe>
                    @else
