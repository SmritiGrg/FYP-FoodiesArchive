<x-app-layout>
    <section class="pt-24 px-5 md:px-24">
        <div class="mx-auto p-4 bg-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1 border-b-2 pb-4 md:border-r-2 md:border-b-0 md:pb-0">
                    <h1 class="text-3xl font-bold mb-6">Tell us, how was your <br> experience?</h1>
                ...
                <!-- Right Column -->
                <div class="md:col-span-2 pl-10">
                    <div class="mb-8">
                        <h3 class="text-xl font-semibold mb-3">Overall Rating</h3>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <p class="text-xl font-medium mr-6">{{$formattedRating}}</p>
                            </div>
                            <span class="text-lg font-medium">{{$foodPost->reviews->count()}} reviews</span>
                        </div>
                    </div>
                    <form action="" method="POST">
                        @csrf
                        <div class="mb-8">
                            <h3 class="text-xl font-semibold mb-3">Rate your food</h3>
                            <div class="flex">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold mb-3">Write your Review</h3>
                            <textarea 
                        ...
                        <button type="submit" class="w-full font-poppins bg-customYellow text-black text-base px-4 py-3 rounded-full font-medium hover:bg-hovercustomYellow transition mt-4">
                            Submit Review
                        </button>
                    </form>
                </div>
