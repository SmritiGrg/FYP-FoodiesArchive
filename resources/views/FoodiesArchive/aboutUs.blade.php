            ...
            <div class="flex flex-col md:flex-row gap-8 items-center mb-16">
                <div class="md:w-1/2">
                    <div class="relative h-[400px] w-full rounded-xl overflow-hidden shadow-xl">
                        {{-- <img src="/placeholder.svg?height=400&width=600" alt="Nepalese cuisine" class="object-cover h-full w-full" /> --}}
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    @php
                        ...
                        ['icon' => '💬', 'title' => 'Q&A Community', 'desc' => 'Ask questions and get answers from fellow food enthusiasts.'],
                        ...
                        ['icon' => '📅', 'title' => 'Food Events', 'desc' => 'Discover and participate in food festivals and culinary events.'],
