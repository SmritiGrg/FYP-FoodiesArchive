<x-app-layout>
    ...
    <section class="px-5 pt-24 lg:px-36 pb-20">
        ...
        <div class="text-center mx-auto">
            <div class="flex justify-center gap-4 my-4 items-center">
                ...
                <h3 class="text-3xl lg:text-5xl text-customYellow font-extrabold">{{ $firstDay->format('F Y') }}</h3>
                ...
                <tbody>
                    <tr>
                        ...
                        @for ($day = 1; $day <= $daysInMonth; $day++)
                            ...
                            <td class="h-20 lg:h-24 relative text-center">
                                {{-- Display food post images as background --}}
